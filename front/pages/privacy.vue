      ...
      <div class="space-y-8">
        ...
        <section>
          ...
          <p class="text-gray-700 leading-relaxed">
            ...
            in this Privacy Policy. When you delete your account, we will delete your personal information within 30 days, 
        ...
        <section>
          ...
          <p class="text-gray-700 leading-relaxed mb-4">
            ...
            cookie settings through your browser preferences. For more information about our use of cookies, please see 
            our Cookie Policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p class="text-gray-700 leading-relaxed">
            ...
            We ensure that such transfers are subject to appropriate safeguards to protect your personal information.
          </p>
        </section>
        ...
        <section>
          ...
          <div class="mt-4 p-4 bg-gray-50 rounded-lg">
            <p class="text-gray-700">
              <strong>Email:</strong> privacy@saasmvp.com<br>
              <strong>Address:</strong> 123 Business St, Tech City, TC 12345<br>
              <strong>Data Protection Officer:</strong> dpo@saasmvp.com
            </p>
          </div>
        </section>
      </div>
